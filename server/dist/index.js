...
_mongoose2.default.connect(_config2.default.mongoose.uri, { useNewUrlParser: true, useUnifiedTopology: true }).catch(function (err) {
...
app.get('/', function (req, res) {
    return res.json({ 'source': 'https://github.com/amazingandyyy/mern' });
});
